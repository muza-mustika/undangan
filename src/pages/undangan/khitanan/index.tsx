...
import { Star, Calendar, MapPin, Users, Clock, Save, Eye, Settings } from 'lucide-react';

const UndanganKhitanan: React.FC = () => {
  ...
  const handleSave = () => {
    ...
    console.log('Saving khitanan invitation:', formData);
  };
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50">
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="bg-white rounded-2xl shadow-xl max-w-4xl mx-auto overflow-hidden">
            {/* Header Preview */}
            <div className="bg-gradient-to-r from-green-400 to-emerald-400 text-white p-8 text-center">
              <div className="mb-4">
                <Star className="w-16 h-16 mx-auto text-white animate-pulse" />
              </div>
            ...
            <div className="p-8">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-700 mb-4">
                  ...
                  Bapak/Ibu/Saudara/i untuk hadir dalam acara tasyakuran khitanan putra kami:
                </p>
                <p className="text-3xl font-bold text-green-600 mb-2">
                  {formData.namaAnak || 'Nama Anak'}
                </p>
                <p className="text-gray-600">
                  Putra dari {formData.namaAyah || 'Bapak'} & {formData.namaIbu || 'Ibu'}
                </p>
              </div>
  ...
  return (
    <div>
      <div className="mb-6 flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Undangan Khitanan</h2>
          <p className="text-gray-600">Buat undangan khitanan yang islami dan elegan</p>
        </div>
            ...
            <div className="space-y-3">
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  name="tema"
                  value="islamic"
                  checked={formData.tema === 'islamic'}
                  onChange={handleInputChange}
                  className="text-green-500 focus:ring-green-500"
                />
                <div>
                  <div className="font-medium">Islamic</div>
                  <div className="text-sm text-gray-500">Islami dan elegan</div>
                </div>
              </label>
              <label className="flex items-center gap-3 cursor-pointer">
                <input
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  name="tema"
                  value="colorful"
                  checked={formData.tema === 'colorful'}
                  onChange={handleInputChange}
                  className="text-green-500 focus:ring-green-500"
                />
                <div>
                  <div className="font-medium">Colorful</div>
                  <div className="text-sm text-gray-500">Ceria dan berwarna</div>
                </div>
              </label>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
              <div className="text-gray-400">
                ...
                <p className="text-xs">Maksimal 4 foto</p>
              </div>
            </div>
          </div>
        </div>
...
export default UndanganKhitanan;
